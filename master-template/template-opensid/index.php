...
define('OPENSID_FOLDER', '{$opensidFolder}');

/** folder symlink domain */
define('SYMLINK_DOMAIN', '{$symlinkDomain}');
...
if (!file_exists('assets')) {
    symlink(OPENSID_FOLDER . DIRECTORY_SEPARATOR . 'assets', 'assets');
}
...
if (!file_exists('composer.json')) {
    symlink(OPENSID_FOLDER . DIRECTORY_SEPARATOR . 'composer.json', 'composer.json');
}
...
// symlink api
if (!file_exists('api')) {
    symlink(SYMLINK_DOMAIN . DIRECTORY_SEPARATOR . 'api-app' . DIRECTORY_SEPARATOR . 'public', 'api');
}
