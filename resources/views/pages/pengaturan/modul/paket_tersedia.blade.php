<div class="tab-pane active">
    <div class="search">
        ...
        <div class="container">
                <form action="{{ route($table.'.store') }}" id="mainform" method="post" enctype="multipart/form-data">
                    @csrf
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (let i in data) {
                            ...
                            disabledPaket = ''
                            buttonInstall = `<button type="submit" ${disabledPaket} name="pasang" value="${data[i].name}___${data[i].url}___" class="btn btn-primary">Pasang</button>`
                            if (paketTerpasang[data[i].name] !== undefined) {
                                ...
                                if (versionCheck > 0) {
                                    ...
                                    buttonInstall = `<button type="submit" ${disabledPaket} name="pasang" value="${data[i].name}___${data[i].url}___v.just-migrate" class="btn btn-primary">Pasang Lagi</button>`
                                }
                            }
                        ...
                        $('div#list-paket').append(cardView.join(''))
                        $('div#list-paket').find('button:submit').click(function() {
                            Swal.fire({
