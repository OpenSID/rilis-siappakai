    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Tema Pro {{ $data->nama_desa ?? '' }}</h5>
                ...
                <table>
                        ...
                        <td align="left">
                            <div class="col-md-12 col-sm-12 d-flex">
                                <select wire:model="selectedTema" id="tema_id" name="tema_id" class="form-select @error('tema_id') is-invalid @enderror" autocomplete="off">
                                    <option value="" readonly>-- {{ $temas != '[]' ? 'Pilih Tema' : 'Belum Berlangganan Tema' }} --</option>
                    ...
                    <tr>
                        ...
                        <td align="left" width="53%">
                            <button wire:click="SimpanTema()" type="button" class="btn btn-success mx-2 {{ $aktif == 'true' ? '' : 'disabled' }}"
...
@push('scripts')
    <script>
        ...
        window.addEventListener('closeModalTambahTema', event => {
            $("#tambahTema-{{ $data->id }}").modal('hide');
        })
    </script>
@endpush
