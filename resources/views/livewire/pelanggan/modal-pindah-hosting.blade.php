            ...
            <table class="table table-striped">
                ...
                <tr>
                    <td align="left">
                        ...
                        <span class="text-danger">( desa.zip atau desa_{{str_replace('.', '', $data->kode_desa)}}.zip
                            )</span>
                    </td>
                    <td><span>:</span></td>
                    <td align="left">
                        <div wire:loading.remove>
                            <input wire:loading.attr="disabled" wire:model.defer="folderdesa" type="file"
                                id="folderdesa" name="folderdesa" class="form-control">
                        </div>
                        ...
                        <div wire:loading wire:target="folderdesa">
                            <div x-show="isUploading">
                                ...
                                <small class="text-danger">Silakan tunggu proses selesai, jangan unggah yang lain
                                    ...!!!</small>
                            </div>
                        </div>
                    </td>
                ...
                <tr class="{{ $openkab == 'true' ? 'd-none' : '' }}">
                    ...
                    <td align="left">
                        <div wire:loading.remove>
                            <input wire:loading.attr="disabled" wire:model.defer="database_opensid" type="file"
                                id="database_opensid" name="database_opensid" class="form-control">
                        </div>
                ...
                <tr>
                    ...
                    <td align="left">
                        <div wire:loading.remove>
                            <input wire:loading.attr="disabled" wire:model.defer="database_pbb" type="file"
                                id="database_pbb" name="database_pbb" class="form-control">
                        </div>
                ...
                <tr>
                    <td align="left" width="50%"><span>Apakah Anda yakin akan pindah hosting ke Dasbor SiapPakai?</span>
                    </td>
                    <td><span>:</span></td>
                    <td align="{{$proses == true ? 'center' : 'left'}}">
                        ...
                        <button wire:click="Batal()" type="button"
                            class="btn btn-secondary {{$hide == true ? 'd-none' : 'd-inline'}}"
                            data-dismiss="modal">Batal</button>
                        <label class="text-primary ms-2">{{ $sukses }}</label>
                        <a class="btn btn-primary {{$proses == true ? 'd-inline' : 'd-none'}}" href="{{ $link }}">Lihat
                            proses</a>
                        <a class="btn btn-secondary {{$proses == true ? 'd-inline' : 'd-none'}}" href="{{ $link_close }}">Tutup</a>
                    </td>
                </tr>
            </table>
        </form>
