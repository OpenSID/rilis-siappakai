    ...
    <div x-data="{ isNewsite: false, progress: 0 }" x-on:livewire-upload-start="isNewsite = true"
        ...
        <div class="item form-group d-flex">
            ...
            <div class="col-md-8 col-sm-8">
                <select class="form-select" wire:model="pilih_pendaftaran" id="pilih_pendaftaran" name="pilih_pendaftaran"
                    class="form-control @error('pilih_pendaftaran') is-invalid @enderror" autocomplete="off">
        ...
        @if ($pilih_pendaftaran == 'false' && $opensid == 3)
            <div class="item form-group d-flex">
                ...
                <div class="col-md-8 col-sm-8">
                    <select class="form-select" wire:model="selectedOpensid" id="pilih_opensid"
                        name="pilih_opensid" class="form-control @error('pilih_opensid') is-invalid @enderror"
                        autocomplete="off">
        ...
        <div class="{{ $pilih_pendaftaran == 'false' ? 'd-inline' : 'd-none' }}">
            ...
            <div class="item form-group d-flex">
                ...
                <div class="col-md-8 col-sm-8">
                    <select class="form-select" wire:model="terdaftar_layanan" id="terdaftar_layanan"
                        name="terdaftar_layanan" class="form-control @error('terdaftar_layanan') is-invalid @enderror"
                        autocomplete="off" @disabled($pilih_opensid == 1 || $opensid == 1)>
            ...
            @if ($terdaftar_layanan == 'false' || ($pilih_opensid == 1 && $opensid == 3))
                <div class="item form-group d-flex">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <input type="text" wire:model="domain_opensid" id="domain_opensid" name="domain_opensid"
